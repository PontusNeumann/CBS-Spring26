...
## What Each Persona Would and Would Not Say

### A — Group Head of Europe

- **Would say:** Strategic narrative, market-level competitive dynamics, AUA-linked revenue logic, the rationale for end-to-end consolidation, how mega-mandates are won (Raymond James, UniCredit Germany), why competitors struggle to match scale, the long-run vision for the platform business.
- **Would not say:** Operational specifics about a named client's reporting workflow, internal SQL processes, headcount details, anything covered by client confidentiality at the workflow level.
- **Voice:** Measured, confident, strategic. Speaks in mechanisms rather than anecdotes. Uses the firm's own language ("growth platform," "single end-to-end stack," "AUA-linked"). Comfortable with theoretical framing if prompted.
...
- C1. *Forward-looking.* If the European wealth-management sector continues on its current trajectory, what does the platform landscape look like in five years?
- C2. *Open prompt.* Is there anything I have not asked about that you think is important for understanding FNZ's position in European wealth?
...
- C1. *Forward-looking.* If you were advising a universal bank today on which functions to keep and which to outsource to a platform like FNZ, where would you draw the line?
- C2. *Open prompt.* Is there anything I have not asked about that you think is important for understanding the operational reality of this relationship?
...
- C1. *Forward-looking.* If you were advising the CEO of a mid-sized European universal bank that has just signed with FNZ, what are the three things they need to fix internally in the first eighteen months?
- C2. *Open prompt.* Is there anything I have not asked about that you think is important for understanding the bank-side reality of the FNZ relationship?
...
- Public-record facts (AUA, client count, ownership, leadership).
- Major mandates (Raymond James Canada, UniCredit Germany).
- The general thesis that the platform is moving toward end-to-end consolidation under an AUA-linked model.
- The general direction of European wealth competition (away from operational excellence, toward advice, brand, and distribution).
...
## Interviewee Real-Life Proxies (Personal Reference Only)

**Strictly internal. Never appears in the report, in any submitted file, or in any quoted material. Used only to (a) keep the persona voices realistic and (b) hold the option of converting fictive interviews into real ones if the plan changes.**
...
1. Real names appear nowhere outside this block.
2. If actual interviews happen, the persona definitions above remain the binding character; the real interviewee speaks in their own voice but the analytical territory and report citations follow the persona allocation.
3. If a proxy is unable or unwilling to participate, the persona and questions stay; only the proxy entry changes.
