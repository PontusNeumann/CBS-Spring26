...
| Empirical material | Confidential interview with a senior FNZ employee (anonymized), supplemented by public-record corporate facts |
...
The empirical material in the report is presented as drawing on a **confidential, anonymized interview with a senior FNZ employee**, conducted under the firm's confidentiality terms. The interview is referenced in-text as e.g. *(FNZ Interview, 2026)* with a corresponding entry in the references list flagged as anonymized per company confidentiality. This is what justifies the front-page confidentiality statement.
...
- **Move 1.** Transaction-cost economics and the Move-to-the-Middle hypothesis explain *why* banks outsource. Theory predicts a hybrid governance form with a small number of specialized partners.
...
The discussion implications described in §8 of this plan follow from these three moves: incumbent banks face a differentiation and capability-rebuilding question, and the sector faces a concentration-risk question.
...
### Confidential interview (cite as anonymized primary source)
...
- Reference list entry flags the source as anonymized per company confidentiality.
...
Body total: 10 pages. Each section earns its budget by serving at least one LO. The former separate analytical and action-oriented material is now folded into **Discussion**. This keeps the report closer to a conventional academic structure while still satisfying LO4, because the discussion must evaluate the trade-offs and propose solution implications for banks, FNZ, and sector governance.
...
The empirical base is small in N, drawn from a single firm, and anonymized at source. Triangulation is provided by public-record corporate evidence and syllabus literature, and the analytical method explicitly tests prediction against observation rather than relying on the interview material as confirmation.
