...
def compute_pre_yes_price_corrected(raw: pd.DataFrame) -> np.ndarray:
    """Per-token-price bug fix. Same algorithm as 11_realistic_backtest.py."""
    df = raw.copy()
...
def compute_cost_edge(test, p_hat, cost_floor=0.05):
    ...
    return cost, p_hat - cost, trader_side_wins_yes
