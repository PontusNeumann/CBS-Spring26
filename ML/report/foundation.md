...
└── scripts/                                 # Data pipeline + modelling code.
    ...
    └── _check_causal.py                     # Regression guard: 54 causal invariants over the consolidated CSV. Run after any rebuild; non-zero exit on regression.
```
